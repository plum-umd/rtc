...
instance methods (class methods and fields are not yet supported, but
an implemention will be shortly forthcoming). It's basic form is:
  typesig("name: type")
...
t. If your class is parameterized over multiple types, use a comma
separated list:
...
possibilities for the error behavior:

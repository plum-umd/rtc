...
module AbstractController::Callbacks::ClassMethods
  ...
  check_method_spec = Dsl.create_spec do 
    pre_task do |*filters|
      Dsl.state[:filter_methods] = [] if not Dsl.state[:before_filter_methods]
      Dsl.state[:filter_methods].push([filters, self])
    end    

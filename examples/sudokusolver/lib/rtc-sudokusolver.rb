...
class SudokuSolver
  ...
  typesig("assign: (Hash<String, String>, String, String) -> Boolean or Hash<String, String>", {"mutate" => true})
  ...
  typesig("eliminate: (Hash<String, String>, String, String) -> Boolean or Hash<String, String>", {"mutate" => true})
  ...
  typesig("search: (Hash<String, String>) -> Boolean or Hash<String, String>", {"mutate" => true})
  def search(values)
  ...
  typesig("check_solution: (Hash<String, String>) -> Boolean")
